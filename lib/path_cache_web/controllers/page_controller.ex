defmodule PathCacheWeb.PageController do
  use PathCacheWeb, :controller

  alias PathCache.Pages
  alias PathCache.Pages.Page
  plug PathCacheWeb.Plug.DummyPlug, [redirect_path: page_path(PathCacheWeb.Endpoint, :index)]
